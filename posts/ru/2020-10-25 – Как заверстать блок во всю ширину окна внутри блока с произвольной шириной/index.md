...
<%- include('/svg/history.svg') %>В оригинале пост предлагал тут JS-костыль: скрипт считал ширину окна без скроллбара и клал её в CSS-переменную. С тех пор появилось решение получше.
