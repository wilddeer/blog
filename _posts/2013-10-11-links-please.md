...
Можно также использовать любой другой тег, например `span`, но он не попадет в *taborder*, а событие *click* не будет вызываться по нажаьтю энтера и пробела, что убивает все преимущества кнопки в плане _accessability_.
...
Несмотря на то, что сейчас сложно найти устройтво с отключенный яваскриптом, ситуации, когда скрипт по той или иной причине не загружается или выполняется с ошибкой, случаются довольно часто, поэтому грамотные фоллбеки помогут сохранить функционал сайта в самых разных ситуациях.
